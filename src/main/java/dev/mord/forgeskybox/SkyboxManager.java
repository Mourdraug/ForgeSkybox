...
import dev.mord.forgeskybox.util.object.internal.Metadata;
...
public class SkyboxManager {
    ...
    public static AbstractSkybox parseSkyboxJson(ResourceLocation id, JsonObjectWrapper objectWrapper) {
        ...
        SkyboxType<? extends AbstractSkybox> type = SkyboxType.REGISTRY_SUPPLIER.get().getValue(metadata.getType());
