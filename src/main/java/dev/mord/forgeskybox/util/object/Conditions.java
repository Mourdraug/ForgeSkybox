package dev.mord.forgeskybox.util.object;
...
public class Conditions {
    ...
    public Conditions(List<ResourceLocation> biomes, List<ResourceLocation> worlds, List<Weather> weathers, List<MinMaxEntry> xRanges, List<MinMaxEntry> yRanges, List<MinMaxEntry> zRanges){
        this.biomes = biomes;
        this.worlds = worlds;
    ...
    public Conditions(List<ResourceLocation> biomes, List<ResourceLocation> worlds, List<Weather> weathers, List<MinMaxEntry> xRanges, List<MinMaxEntry> yRanges, List<MinMaxEntry> heights, List<MinMaxEntry> zRanges){
        this.biomes = biomes;
        this.worlds = worlds;
        this.weathers = weathers;
        this.xRanges = xRanges;
